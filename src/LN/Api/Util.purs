...
-- | A basic POST mechanism for LN. Used for non-authenticated requests.
qlPost :: forall eff r a. (Respondable r, Requestable a)
      => String -> a -> Aff (ajax :: AJAX | eff) (AJ.AffjaxResponse r)
qlPost = qlReqHeaders []

-- | A POST mechanism for LN that sends an authentication token to be
